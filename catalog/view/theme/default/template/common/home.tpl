...
<div class="container">
    ...
    <p><a href="javascript:void(0)" class="collapse-dropdown-link js-dropdown-link" data-toggle="js-full-text"><span class="closed-text">Читать полностью</span><span class="opened-text">Свернуть</span></a></p>
