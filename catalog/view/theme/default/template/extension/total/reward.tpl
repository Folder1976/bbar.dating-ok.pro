<div class="panel panel-default">
  ...
  <div id="collapse-reward" class="panel-collapse" style="display: none;">
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="submit" value="<?php echo $button_reward; ?>" id="button-reward" data-loading-text="<?php echo $text_loading; ?>"  class="g-btn" />
        </span></div>
