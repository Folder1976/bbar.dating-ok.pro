<div class="panel panel-default">
  ...
  <div id="collapse-voucher" class="panel-collapse" style="display: none;">
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <input type="submit" value="<?php echo $button_voucher; ?>" id="button-voucher" data-loading-text="<?php echo $text_loading; ?>"  class="g-btn" />
        </span> </div>
