  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 contact-info">
        ...
        <div><i class="ico-email"></i><span><a href="mailto:<?php echo $config_email; ?>"><?php echo $config_email; ?></a></span></div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="collapse contact-form">
          ...
          <div class="buttons">
            <div class="pull-right">
              <input class="g-btn btn-primary" type="submit" value="<?php echo $button_submit; ?>" style="margin-right: 15px;" />
            </div>
          </div>
        </form>
      </div>
